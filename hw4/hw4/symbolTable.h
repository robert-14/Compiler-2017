...
typedef struct SymbolTable
{
    ...
    //SymbolTableEntry** scopeDisplay; store element in same scope
    struct SymbolTable* uppertable;
    struct SymbolTable* downtable;
    int currentLevel;
    //int scopeDisplayElementCount; scope number
} SymbolTable;
